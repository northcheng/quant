...
def add_mean_reversion_features(df, n=100, close='Close', open='Open', high='High', low='Low', volume='Volume', fillna=False, cal_signal=True, mr_threshold=2):
  ...
  # calculate mr signal
  if cal_signal:
    df['rate_signal'] = cal_boundary_signal(df=df, upper_col='rate', lower_col='rate', upper_boundary=mr_threshold, lower_boundary=-mr_threshold, pos_signl=1, neg_signal=-1, none_signal=0)
